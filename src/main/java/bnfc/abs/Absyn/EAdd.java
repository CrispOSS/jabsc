...
public class EAdd extends PureExp {
  public final PureExp pureexp_1, pureexp_2;
  public EAdd(PureExp p1, PureExp p2) { pureexp_1 = p1; pureexp_2 = p2; }

  public <R,A> R accept(bnfc.abs.Absyn.PureExp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof bnfc.abs.Absyn.EAdd) {
      bnfc.abs.Absyn.EAdd x = (bnfc.abs.Absyn.EAdd)o;
