...
public class EMod extends PureExp {
  public final PureExp pureexp_1, pureexp_2;
  public EMod(PureExp p1, PureExp p2) { pureexp_1 = p1; pureexp_2 = p2; }

  public <R,A> R accept(bnfc.abs.Absyn.PureExp.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof bnfc.abs.Absyn.EMod) {
      bnfc.abs.Absyn.EMod x = (bnfc.abs.Absyn.EMod)o;
