...
public class SGive extends Stm {
  public final PureExp pureexp_1, pureexp_2;
  public SGive(PureExp p1, PureExp p2) { pureexp_1 = p1; pureexp_2 = p2; }

  public <R,A> R accept(bnfc.abs.Absyn.Stm.Visitor<R,A> v, A arg) { return v.visit(this, arg); }

  public boolean equals(Object o) {
    if (this == o) return true;
    if (o instanceof bnfc.abs.Absyn.SGive) {
      bnfc.abs.Absyn.SGive x = (bnfc.abs.Absyn.SGive)o;
